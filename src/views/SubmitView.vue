...
const form = reactive({ province: '', city: '', district: '', callsign: '', stationName: '', rxMhz: 439.5, txMhz: 434.5, ctcssHz: 88.5 as number | null, mode: 'FM', rxOnly: false, sourceUrl: '', sourceDate: null as number | null, note: '' })
